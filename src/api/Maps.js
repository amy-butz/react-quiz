     ...
     return (
        <div className="map">
            <p>Your personality is <strong>New York City.</strong>
                ...
                and pretty much everything you do could be followed with #LikeABoss.
            </p>
            <MapContainer
                width="400px"
                google={props.google}
    ...
    return (
        <div className="map">
            <p>Your personality is <strong>Los Angeles.</strong>
                ...
                connections with people, whether at a cocktail party or one-on-one over coffee.
            </p>
            <MapContainer
                google={props.google}
                initialCenter={{
...
function SteadyMap(props) {
     return (
        <div className="map">
            <p>Your personality is <strong>Provo, Utah.</strong>
                You are a strong and steady individual. You value family, community, tradition, beauty, and harmony.
                You keep your home, car, and office tidy.
                You appreciate quiet time, and you'd prefer a home-cooked dinner with family and friends over a wild party.
                You are patient, humble, and genuinely interested in giving
    ...
    return (
        <div className="map">
            <p>Your personality is <strong>Washington DC.</strong>
                ...
                appeal to you, your kindness also makes you a trustworthy and thoughtful friend.
            </p>
            <MapContainer
                width="400px"
                google={props.google}
    ...
    return (
        <div className="map">
            <p>Your personality is <strong>Nashville.</strong>
                ...
                Basically, you like variety and you are good at keeping things in balance.
            </p>
            <MapContainer
                width="400px"
                google={props.google}
